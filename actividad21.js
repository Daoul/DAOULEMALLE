window.addEventListener('load', () =>{
    ...
    formulario.addEventListener('submit', function(){
        ...
        if(nombre.trim() == null || nombre.trim() == ""){
            ...
            document.querySelector("#error_nombre").innerHTML = "Nombre valido";
            document.querySelector("#error_nombre").style.color = "green";
        }

        if(apellido.trim() == null || apellido.trim() == ""){
            document.querySelector("#error_apellidos").innerHTML = "Apellidos no valido";
            document.querySelector("#error_apellidos").style.color = "red";
            return false
        }else{
            document.querySelector("#error_apellidos").innerHTML = "Apellidos valido";
        ...
        if(edad.trim() == null || edad.trim() == ""){
            ...
            document.querySelector("#error_edad").innerHTML = "Edad valido";
